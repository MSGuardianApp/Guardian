...
namespace SOS.Phone.Utilites.UtilityClasses
{
    ...
    public class WPClogger
    {
        ...
        private const String fileName = "GuardianAppErrorCLog.xml";
        private LogLevel loggerLevel = LogLevel.warn;
        private XDocument loadedDoc = null;
        #endregion

        #region configurable variables
        private const String emailAddress = "GuardianApp@outlook.com";
        private const String emailDefaultUserComments = "Guardian App Complete issue trace log";
        private const String emailSubject = "Guardian App issue Report ";
        ...
        public void emailReport(String userComments, String subject)
        {
            ...
            if (subject == null)
            {
                emailTask.Subject = emailSubject+ DateTime.Now.ToString();
            }
            else
            {
            ...
            builder.AppendLine("\n\nBug reporting provided by GuardianLogger");
...
#pragma warning restore
        ...
        public bool hasCriticalLogged()
        {
            if (loadDocument())
            {
                ...
                {
                    if (el.Attribute("level").Value.Equals(levelLabel[(int)LogLevel.critical]) || el.Attribute("level").Value.Equals(levelLabel[(int)LogLevel.error]))
                    {
                        return true;
                    }
                }
        ...
        private void createDocument()
        {
            ...
            XElement root = new XElement("GuardianLog");
