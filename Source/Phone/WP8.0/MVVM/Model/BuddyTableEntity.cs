...
{
    [Table]
    public class BuddyTableEntity : INotifyPropertyChanged, INotifyPropertyChanging
    {
        private int _BID;
        /// <summary>
        ...
        private string _buddyRelationshipId;
        [Column]
        public string BuddyRelationshipId
        {
            get
            {
                return _buddyRelationshipId;
            }
            set
            {
                if (value != _buddyRelationshipId)
                {
                    NotifyPropertyChanging("BuddyRelationshipId");
                    _buddyRelationshipId = value;
                    NotifyPropertyChanged("BuddyRelationshipId");
                }
            }
        }
        ...
        private bool _isPrimeBuddy;
        /// <summary>
        /// IsPrimeBuddy flag to determine whether the Buddy is default caller or not.
        /// </summary>
        /// <returns></returns>
        [Column]
        public bool IsPrimeBuddy
        {
            get
            {
                return _isPrimeBuddy;
            }
            set
            {
                if (value != _isPrimeBuddy)
                {
                    NotifyPropertyChanging("IsPrimeBuddy");
                    _isPrimeBuddy = value;
                    NotifyPropertyChanged("IsPrimeBuddy");
                }
            }
        }
