...
- (NSError *)doQuery:(NSString *)sql {
    ...
    if (openError == nil) {
        ...
        if(sqlite3_prepare_v2(db, query, -1, &statement, NULL) == SQLITE_OK) {
            ...
            //lastID = [NSString stringWithFormat:@"%@",[[NSNumber alloc] initWithLongLong:sqlite3_last_insert_rowid(db)]] ;
        }
...
-(BOOL)recordExistOrNot:(NSString *)query{
    ...
    query = [query stringByReplacingOccurrencesOfString:@"(null)" withString:@""];
