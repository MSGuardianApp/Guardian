...
{
   public class  StorageAccessDestination
    {
     private Microsoft.WindowsAzure.Storage.CloudStorageAccount _StorageAccount = null;
        ...
        public StorageAccessDestination()
        {
            _StorageAccount = Microsoft.WindowsAzure.Storage.CloudStorageAccount.Parse(Config.DestStorageConnection);
